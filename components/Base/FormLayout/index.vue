...
type Form = DynamicObject<string | number | boolean | FileList>
      ...
      if (form instanceof HTMLFormElement) {
        ...
        for (const key of keyedElements) {
          ...
          if (field) {
            ...
            const value =
              field.type === 'file'
                ? (field as HTMLInputElement).files
                : field.type === 'number'
      ...
      if (form instanceof HTMLFormElement) {
        ...
        if (setInitial) {
          ...
          const keyedElements = Object.keys(
            ...
            if (field.type === 'text' || field instanceof HTMLTextAreaElement) {
