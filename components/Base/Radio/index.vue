...
<template>
  <Id v-slot="idProps">
    ...
    >
      <span :class="iconClass" class="flex-centered group">
        <span
          class="relative rounded-full w-18 h-18 border inline-flex fill-before before:!w-10 before:!h-10 before:!inset-[auto] before:bg-action-primary-default items-center justify-center before:scale-0 before:transition-transform lg:transition-all bg-surface-default group-focus-within:border-action-primary-pressed group-focus-within:border-2"
          :class="[
            {
              'border-interactive-default !border-2 before:scale-100 group-active:before:scale-[0.95] before:delay-75':
                modelSync,
